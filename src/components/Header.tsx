    ...
    return (
        <header className={classes.header}>
            ...
            <nav className="flex justify-center items-center gap-2.5 w-fit">
                <Link href={'/experience'} className="text-gray transition duration-500 border-b-2 border-transparent pb-3 hover:border-green hover:text-white">
                    Experience
                </Link>
                <Link href={'/projects'} className="text-gray transition duration-500 border-b-2 border-transparent pb-3 hover:border-green hover:text-white">
                    Projects
                </Link>
                <Link href={'/contact'} className="text-gray transition duration-500 border-b-2 border-transparent pb-3 hover:border-green hover:text-white">
                    Contact
                </Link>
            </nav>
        </header>
